...
export const PRESET_MANAGER_SKULT: string[] = [
  // Pages
  "/dashboard", "/rapports", "/planning", "/pointage", "/cloture",
  "/staff", "/dispos-monitoring", "/demandes", "/feedbacks",
  "/formation", "/assistant-ia", "/notifications", "/signalements", "/trous",
  // Sous-actions
  "/planning:write",
  "/pointage:edit",
  "/cloture:read_responses",
  "/cloture:review_photos",
  "/feedbacks:reply",
  "/demandes:accept_refuse",
  "/signalements:resolve",
  "/assistant-ia:add_knowledge",
  "/trous:assign",
  "/trous:send_proposals",
];
