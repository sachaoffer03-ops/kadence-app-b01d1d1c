  ...
  return (
    <>
      ...
      <div className="px-3 pt-6 pb-5">
        <img src={logo} alt="Kadence" style={{ width: "100%", height: "auto", display: "block" }} />
        <div style={{ fontSize: 11, color: "var(--muted-foreground)", marginTop: 6, paddingLeft: 2 }}>Skult Studios</div>
      </div>
