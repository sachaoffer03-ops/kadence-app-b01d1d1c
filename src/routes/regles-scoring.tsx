...
import { ChevronDown, ChevronUp, AlertTriangle, Leaf, Scale, Target } from "lucide-react";
import {
  getScoringSettings,
  setScoringProfile,
  updateScoringRule,
...
export const Route = createFileRoute("/regles-scoring")({
  component: ReglesScoringPage,
  head: () => ({ meta: [{ title: "Règles de scoring — Kadence" }] }),
});
...
function ReglesScoringPage() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-[1400px]">
      <div className="mb-5">
        <h1 style={{ fontSize: 18, fontWeight: 500, marginBottom: 2 }}>Règles de scoring</h1>
        <p style={{ fontSize: 13, color: "var(--muted-foreground)" }}>
          Configure comment les employés gagnent des points à chaque shift.
        </p>
      </div>
